    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="border-b border-bwave-blue/20 bg-slate-900/50 backdrop-blur-sm shadow-lg" role="banner">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <a
            href="/app/dashboard"
            className="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-bwave-blue focus:ring-offset-2 focus:ring-offset-gray-900 rounded px-2 py-1"
          >
